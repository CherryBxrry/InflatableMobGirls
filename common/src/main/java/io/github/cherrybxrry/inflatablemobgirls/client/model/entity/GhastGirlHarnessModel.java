...
public class GhastGirlHarnessModel extends EntityModel<GhastGirlRenderState> {
    ...
    private final ModelPart strap_l;
    private final ModelPart strap_r;
    ...
    public GhastGirlHarnessModel(ModelPart root) {
        super(root);

        this.neck = root.getChild("root").getChild("hips").getChild("spine").getChild("chest").getChild("neck");
        this.head = this.neck.getChild("head");
        this.goggles = this.head.getChild("harness").getChild("goggles");
        this.strap_l = this.head.getChild("harness").getChild("strap_l");
        this.strap_r = this.head.getChild("harness").getChild("strap_r");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition chest = spine.addOrReplaceChild("chest", CubeListBuilder.create(), PartPose.offset(0.0F, -4.0F, -0.25F));
        ...
        PartDefinition harness = head.addOrReplaceChild("harness", CubeListBuilder.create().texOffs(0, 0).addBox(-9.0F, -7.0F, -9.0F, 18.0F, 15.0F, 18.0F, new CubeDeformation(0.0F))
                .texOffs(0, 33).addBox(-7.0F, -8.75F, -9.0F, 14.0F, 2.0F, 18.0F, new CubeDeformation(-0.2F)), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition goggles = harness.addOrReplaceChild("goggles", CubeListBuilder.create().texOffs(0, 53).addBox(-9.0F, -3.5F, -3.5F, 18.0F, 7.0F, 7.0F, new CubeDeformation(0.15F)), PartPose.offset(0.0F, 2.5F, -5.5F));

        PartDefinition strap_l = harness.addOrReplaceChild("strap_l", CubeListBuilder.create().texOffs(50, 53).addBox(0.0F, 0.0F, -2.5F, 0.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.0F, -2.0F, 0.0F, 0.0F, 0.0F, 0.0873F));

        PartDefinition strap_r = harness.addOrReplaceChild("strap_r", CubeListBuilder.create().texOffs(50, 53).mirror().addBox(0.0F, 0.0F, -2.5F, 0.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(9.0F, -2.0F, 0.0F, 0.0F, 0.0F, -0.0873F));
    ...
    public void setupAnim(@NonNull GhastGirlRenderState state) {
        ...
        this.strap_l.zRot = 0.1F * Mth.sin(state.ageInTicks * 0.05F) + 0.15F;
        this.strap_r.zRot = -0.1F * Mth.sin(state.ageInTicks * 0.05F) - 0.15F;
